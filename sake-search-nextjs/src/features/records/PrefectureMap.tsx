...
import { usePrefectureStats, PrefectureStats } from '@/features/records/hooks/usePrefectureStats';
import { JapanMapJS } from '@/components/maps/JapanMapJS';
        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          ...
          <div className="grid grid-cols-3 md:grid-cols-6 lg:grid-cols-8 gap-2">
            {conquestStats.unConqueredPrefectures.map(prefecture => (
              <div 
                key={prefecture.id}
                className="px-3 py-2 bg-gray-100 text-gray-800 rounded-lg text-sm text-center hover:bg-gray-200 transition-colors"
              >
                {prefecture.name}
              </div>
            ))}
