...
export default function AdminDashboard() {
  ...
  const uniquePrefectures = [...new Set(allSakeData.map(sake => sake.prefecture).filter(Boolean))];
  const prefectures = prefectureOrder.filter(pref => uniquePrefectures.includes(pref));
